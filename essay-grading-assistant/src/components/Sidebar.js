...
export default function Sidebar() {
  ...
  return (
    <div className={`h-screen flex flex-col bg-white border-r transition-all duration-300 ${
      isOpen ? 'w-64' : 'w-16'
    }`}>
      ...
      <div className="p-4 border-t text-black">
        ...
        <button
          ...
          className="flex items-center text-red-600 hover:bg-red-50 p-2 rounded-md w-full"
        >
